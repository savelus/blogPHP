    ...
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">
                * {{$date->translatedFormat('F')}} {{$date->day}}, {{$date->year}} * {{$date->format('H:30')}} *
                Featured * {{$post->comments->count()}} комментария *</p>
                ...
                <div class="col-lg-9 mx-auto">
                    ...
                    @foreach($post->comments as $commment)
                            ...
                            <span class="username">
                                ...
                                <span class="text-muted float-right">{{$commment->dateAsCarbon->diffForHumans()}}</span>
                            </span><!-- /.username -->
                                {{$commment->message}}
                            </div>
                        @endforeach
